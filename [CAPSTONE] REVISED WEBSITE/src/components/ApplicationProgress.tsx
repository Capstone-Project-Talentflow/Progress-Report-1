                ...
                return (
                  <>
                    ...
                    <div className="mt-6 flex gap-3">
                      <button className="flex-1 bg-[#ffca1a] hover:bg-[#e6b617] text-gray-900 px-6 py-3 rounded-lg transition-colors flex items-center justify-center gap-2">
                        <FileText className="w-5 h-5" />
                        <span>View Application</span>
                      </button>
                      {app.statusType !== 'rejected' && app.statusType !== 'accepted' && (
                        <button className="flex-1 bg-white hover:bg-gray-50 text-gray-900 px-6 py-3 rounded-lg border-2 border-gray-200 transition-colors">
