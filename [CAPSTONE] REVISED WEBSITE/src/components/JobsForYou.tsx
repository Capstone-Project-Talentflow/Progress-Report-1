...
export function JobsForYou({ onApply, onSaveJob, savedJobIds }: JobsForYouProps) {
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <Badge className="bg-[#ffca1a] text-gray-900">
                  ...
                  <div className="text-right ml-4">
                    <p className={`text-2xl ${getMatchColor(job.matchScore)}`}>{job.matchScore}%</p>
        ...
        <Card className="mt-8 bg-white border-gray-200">
          <CardContent className="p-8 text-center">
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              <Button className="bg-[#ffca1a] hover:bg-[#e6b617] text-gray-900">
                Update Profile
              </Button>
