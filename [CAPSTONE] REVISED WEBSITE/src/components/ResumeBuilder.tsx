  ...
  const ResumePreview = () => (
    <div className="bg-white rounded-lg p-6 sm:p-8">
      ...
      <div>
        {/* Name */}
        <div className="mb-6">
          <p className="text-base sm:text-lg md:text-xl font-semibold text-[#101828] uppercase tracking-wide">
            {personalInfo.fullName || 'YOUR NAME'}
          </p>
          <div className="mt-2 text-xs sm:text-sm text-[#4a5565] space-y-1">
        ...
        {workExperiences.length > 0 && workExperiences[0].position && (
          <div className="mb-6">
            <p className="text-sm sm:text-base md:text-lg font-semibold text-[#101828] uppercase mb-3 border-b-2 border-[#101828] pb-1">
              Work Experience
            </p>
                  ...
                  <div key={index}>
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-1 gap-1">
                      <div className="flex-1">
                        <p className="text-sm sm:text-base font-semibold text-[#101828]">{exp.position}</p>
                        <p className="text-xs sm:text-sm text-[#4a5565]">
                          {exp.company}{exp.location && `, ${exp.location}`}
                        </p>
                      </div>
                      <p className="text-xs sm:text-sm text-[#4a5565] whitespace-nowrap">
                        {exp.startDate} - {exp.current ? 'Present' : exp.endDate}
                      </p>
                    </div>
                    {exp.description && (
                      <p className="text-xs sm:text-sm text-[#4a5565] mt-1">{exp.description}</p>
                    )}
                  </div>
                )
              ))}
              ...
              {education.map((edu, index) => (
                edu.degree && (
                  <div key={index}>
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-1 gap-1">
                      <div className="flex-1">
                        <p className="text-sm sm:text-base font-semibold text-[#101828]">{edu.degree}</p>
                        <p className="text-xs sm:text-sm text-[#4a5565]">
                    ...
                    {edu.achievements && (
                      <p className="text-xs sm:text-sm text-[#4a5565] mt-1">{edu.achievements}</p>
                    )}
                  </div>
                )
              ))}
              ...
              {organizations.map((org, index) => (
                org.organization && (
                  <div key={index}>
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-1 gap-1">
                      <div className="flex-1">
                        <p className="text-sm sm:text-base font-semibold text-[#101828]">{org.role}</p>
                        <p className="text-xs sm:text-sm text-[#4a5565]">{org.organization}</p>
                      </div>
                      <p className="text-xs sm:text-sm text-[#4a5565] whitespace-nowrap">
                    ...
                    {org.description && (
                      <p className="text-xs sm:text-sm text-[#4a5565] mt-1">{org.description}</p>
                    )}
                  </div>
                )
              ))}
              ...
              {skills.map((skill, index) => (
                skill.name && (
                  <div key={index} className="flex items-center justify-between">
                    <p className="text-xs sm:text-sm text-[#4a5565]">{skill.name}</p>
                    <p className="text-xs sm:text-sm text-[#4a5565] font-medium">{skill.level}</p>
                  </div>
                )
              ))}
            </div>
          ...
          <div className={`${showPreview ? 'block' : 'hidden lg:block'}`}>
            <div className="sticky top-20">
              <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                ...
                <div className="hidden lg:flex items-center justify-between p-4 border-b border-[#e5e7eb]">
                  <p className="text-sm font-semibold text-[#101828]">Resume Preview</p>
                  <button className="bg-[#17960b] text-white rounded-lg px-4 py-2 flex items-center gap-2 text-sm font-semibold hover:bg-[#17960b]/90 transition-colors">
                ...
                <div className="lg:hidden p-4 border-b border-[#e5e7eb]">
                  <button className="w-full bg-[#17960b] text-white rounded-lg px-4 py-3 flex items-center justify-center gap-2 text-sm font-semibold hover:bg-[#17960b]/90 transition-colors">
                    <Download className="w-4 h-4" />
                    DOWNLOAD RESUME
                  </button>
                </div>
