              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-3 mt-2">
                    <span className={`text-sm px-3 py-1 rounded-full font-semibold ${getStatusColor(selectedJobOrder.status)}`}>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <div className="flex items-start space-x-2">
                    <div className="flex-shrink-0">
                      <Briefcase className="w-5 h-5 text-yellow-600 mt-0.5" />
                    </div>
                    <div>
                      <p className="text-sm text-yellow-800">
                        <span className="font-semibold">Note:</span> Job Orders refer to hiring workers for piece work or 
                        intermittent jobs of short duration not exceeding six months with daily or hourly pay basis.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex space-x-3">
              ...
              <button
                onClick={() => {
                  ...
                  if (!jobOrderForm.companyName || !jobOrderForm.deadline) {
                    alert('Please fill in company name and deadline');
                    return;
                  }
